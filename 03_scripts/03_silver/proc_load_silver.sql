...
Purpose     : Creates a stored procedure to clean, transform and load data into  
			  the silver layer.
Parameters  : None
Run         : EXEC silver.load_silver;
--------------------------------------------------------------------------------
WARNING     : This script truncates and reloads all silver tables. All existing
